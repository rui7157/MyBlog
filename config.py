...
class Configuration(object):
    ...
    CHARSET = 'utf8'
    SQLALCHEMY_DATABASE_URI = os.environ.get("DATABASE_URL") or "mysql+pymysql://{u}:{p}@{h}:{P}/{db}".format(u=sae.const.MYSQL_USER,p=sae.const.MYSQL_PASS,h=sae.const.MYSQL_HOST,P=sae.const.MYSQL_PORT,db=sae.const.MYSQL_DB)  #os.getenv("sql",default="mysql+pymysql://root:@127.0.0.1/myblog")  
